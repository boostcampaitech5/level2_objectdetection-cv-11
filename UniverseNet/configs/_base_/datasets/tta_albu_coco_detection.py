...
tta_flip = True
tta_scale = [(w,w) for w in range(512, 1024+1, 128)]
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file='/opt/ml/Object_Detection/EDA/new_coco_dataset.json',
        # /opt/ml/Object_Detection/EDA/new_coco_dataset.json
        # /opt/ml/dataset/2___train_MultiStfKFold.json
        # /opt/ml/dataset/2___val_MultiStfKFold.json
        # /opt/ml/dataset/1___val_MultiStfKFold.json
        img_prefix=data_root,
        classes=classes,
