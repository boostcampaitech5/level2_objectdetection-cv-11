...
parser.add_argument('--trainset', default='train.json', help='input your trainset')
parser.add_argument('--validset', default='train.json', help='input your validset')
...
def inference(cfg):
    ...
    submission.to_csv(os.path.join(cfg.work_dir, f'tta_{epoch}.csv'), index=None)
    submission.head()
