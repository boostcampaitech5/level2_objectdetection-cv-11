...
def data_config(cfg: Config) -> None:
    ...
    # 이거 변경========================================================
    cfg.data.samples_per_gpu = 1 # 원래 8
    # =================================================================
...
def inference(cfg):
    ...
    checkpoint_path = '/opt/ml/baseline/level2_objectdetection-cv-11/UniverseNet/work_dirs/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco_trash/universe_all_20epoch_exp5.pth'
