...
parser.add_argument('--model', default="tta_universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco", help='input your model_name')
...
def inference(cfg):
    ...
    # infer_pth 여기 하드코딩 수정======================================================
    checkpoint_path = '/opt/ml/level2_objectdetection-cv-11/UniverseNet/work_dirs/exp8/best_bbox_mAP_50_epoch_29.pth'
    ...
    # 여기 폴더명 수정============================================
    aa = '/opt/ml/'
    submission.to_csv(os.path.join(aa, f'tta_onlyflip_3_fold_test.csv'), index=None)
    submission.head()
