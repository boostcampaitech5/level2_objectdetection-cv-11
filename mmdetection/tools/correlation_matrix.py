...
if __name__ == "__main__":
    # gt_json, pred_csv 경로 수정 후 실행
    parser = argparse.ArgumentParser(description='Process some integers.')
    parser.add_argument('--gt_json', type=str, default='/opt/ml/dataset/2___val_MultiStfKFold.json')
    parser.add_argument('--pred_csv', type=str, default='/opt/ml/baseline/baseline_cv11/work_dirs/retinanet_pvtv2-b0_fpn_1x_coco_trash/submission_latest.csv')
