...
from mmdet.core import early_stopping
...
parser.add_argument(
    "--model",
    default="cascade_rcnn_x101_64x4d_fpn_1x_coco",
    help="input your model_name",
)
...
parser.add_argument(
    "--trainset", default="2___train_MultiStfKFold.json", help="input your trainset"
)
parser.add_argument(
    "--validset", default="2___val_MultiStfKFold.json", help="input your validset"
)
parser.add_argument("--resize", default=1024, help="input your resize")
parser.add_argument(
    "--inference_epoch", default="best", help="input your inference epoch"
)
...
def train(cfg, kfold=False):
    ...
    early_stopping = early_stopping.EarlyStoppingCallback(
    patience=1,   # Number of epochs with no improvement after which training will be stopped
    metric="bbox_mAP",   # Metric to monitor for improvement
    rule="greater",   # Whether the metric should be increasing or decreasing
    )

    # 모델 학습
    train_detector(model, datasets[0], cfg, distributed=False, validate=True, callbacks=early_stopping)
