...
parser.add_argument(
    "--model", default="retinanet_pvtv2-b0_fpn_1x_coco", help="input your model_name"
)
...
parser.add_argument(
    "--inference_epoch", default="latest", help="input your inference epoch"
)
...
print(f"../configs/{folder_name}/{model_name}.py")
...
def data_config(cfg: Config) -> None:
    ...
    cfg.data.train.pipeline[4]["img_scale"] = (resize, resize)  # Resize

    cfg.data.val.classes = classes
    cfg.data.val.img_prefix = root
    cfg.data.val.ann_file = root + args.validset  # valid json 정보
    cfg.data.val.pipeline[1]["transforms"][0]["img_scale"] = (resize, resize)  # Resize

    cfg.data.test.classes = classes
    cfg.data.test.img_prefix = root
    cfg.data.test.ann_file = root + "test.json"  # test json 정보
    cfg.data.test.pipeline[1]["transforms"][0]["img_scale"] = (resize, resize)  # Resize
